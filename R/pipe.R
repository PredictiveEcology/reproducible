...
#' be preceded by \code{Cache(...)} (which allows other Cache arguments to be passed).
#'
#' This will take the input arguments of the
#' first function immediately following the \code{Cache()} and the
#' pipe chain until the special \code{%C%} , evaluate them both
