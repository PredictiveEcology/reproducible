...
## modified from https://cdn2.iconfinder.com/data/icons/synchronize-1/24/synchronize-hexagon-1-512.png
imgurl <- "stickers/synchronize-hexagon-1-512.png"

sticker(imgurl, package = "reproducible",
        h_color = "#006dff", h_fill = "#cccccc",
        p_color = "#006dff", p_family = "bree", p_size = 18, p_x = 0.85, p_y = 1.3,
        s_x = 1.05, s_y = 1, s_width = 0.8, s_height = 0.8,
