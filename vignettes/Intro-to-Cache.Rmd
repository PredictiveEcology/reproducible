...
This is relevant for file paths, environments, parallell clusters, functions (which are contained within an environment), and many others (e.g., see ?.robustDigest for methods).
