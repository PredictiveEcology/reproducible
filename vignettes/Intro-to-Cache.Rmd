...
if (requireNamespace("terra")) {
  ...
  # All same, except for some Cache attributes and
  all.equalCache(map1, map2) # TRUE
  all.equalCache(map1, map3, tolerance = 1e6) # TRUE (imprecision with terra::wrap, used by Cache)
  all.equalCache(map1, map4, tolerance = 1e6) # TRUE (imprecision with terra::wrap, used by Cache)
}
```
