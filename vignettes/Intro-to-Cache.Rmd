...
terra::crs(ras) <- "+proj=lcc +lat_0=50 +lat_1=60 +lat_2=70 +lon_0=-100 +datum=WGS84"

newCRS <- "epsg:4326" # A longlat crs

# Derive target extent from source extent
...
# tmplate <- terra::rast(terra::ext(c(-100, -99.99592, 50, 50.00263)), nrows = 300, ncols = 300)
# terra::crs(tmplate) <- newCRS
